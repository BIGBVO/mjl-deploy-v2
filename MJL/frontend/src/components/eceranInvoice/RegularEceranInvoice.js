...
export class RegularEceranInvoice extends Component {
  ...
  addProduct = (e) => {
    ...
    const {quantity, buckets, total_belanja} = this.state
    const kode = this.props.product.kode
    const nama = this.props.product.nama
    var harga = 0;
            ...
            return (
                  <div>
                    ...
                    <span className="pageText">
                      <strong> Nota Eceran Regular </strong>
                    </span>
                    <div>
                    ...
                    <Container className="eceranInvoiceWidth" ref={el => (this.componentRef = el)}>
                      <div className="center">
                        {printed ? (
                          ...
                          <div className="center">
                            <h1 className="tittleT"> REGULAR </h1>
                            <h1> TERIMA KASIH</h1>
                          </div>
                        )}
...
export default connect(mapStateToProps, {getAllProductsCode, getSpecificProductS, 
  createEceranInvoice, finalisedNotaEceran, getErrors})(RegularEceranInvoice);
